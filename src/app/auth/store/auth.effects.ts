...
export class AuthEffects {
    ...
    authLogin = this.actions$.pipe(
        ...
        switchMap((authData : AuthActions.LoginStart) => { //taamelik new observable by taking another observable data
        ...
        map(() => {
            const userData : {
              ...
              if(loadUser.token) {
               ...
               return new AuthActions.AuthenticateSuccess({email : loadUser.email,
              userId : loadUser.id,
